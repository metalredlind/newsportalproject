        ...
        <header className='bg-[#333333] text-[#cccccc]'>
            <div className='px-5 lg:px-8 flex justify-between items-center py-2 border-b border-[#444444]'>
                ...
                <div className='flex space-x-2'>
                    ...
                    <a href="" className="w-8 h-8 flex justify-center items-center bg-black rounded-full hover:bg-slate-500 transition duration-200"><FaXTwitter /></a>
            ...
            <div style={{ backgroundImage: `url(${bg_header.src})`}} 
