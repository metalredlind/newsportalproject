    ...
    return (
        <div className='bg-white rounded-md '>
            <div className='flex justify-between p-4'>
                <h2 className='text-xl font-semibold'>Add Writer</h2>
                ...
                <form onSubmit={submit}>
                    ...
                    <div className='grid grid-cols-2 gap-x-8 mb-3'>
                        ...
                        <div className='flex flex-col gap-y-2'>
                            ...
                            <input required onChange={inputHandle} value={state.password} type="password" placeholder='Password' name='password' className='px-3 py-2 rounded-md outline-0 border border-gray-300 focus:border-blue-500 h-10' id='password' />
                        </div>
                    </div>
