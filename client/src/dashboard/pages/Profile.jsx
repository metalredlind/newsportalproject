        ...
        <div className='w-full grid grid-cols-1 lg:grid-cols-2 gap-2 mt-5'>
            ...
            <div className='bg-white p-6 rounded-lg flex items-center shadow-md'>
                ...
                <div className='ml-6 text-gray-700 flex flex-col space-y-2'>
                    <h3 className='text-xl font-bold'>Admin1</h3>
                    <p className='text-sm '>Email: <span className='text-gray-600'>admin1@gmail.com</span></p>
                    <p className='text-sm '>Category: <span className='text-gray-600'>Technology</span></p>
                </div>
            </div>
