        ...
        <div className='mt-6'>
            ...
            <div className='bg-white p-6 mt-8 rounded-lg shadow-md'>
                <div className='flex justify-between items-center pb-4 border-b border-gray-500'>
                    ...
                    <Link to='/news' className='text-blue-500 hover:text-blue-800 font-semibold transition duration-200'>
                        View All
                    </Link>
                </div>
                            ...
                            {[1,2,3].map((item, index) => (
                                <tr key={index} className='border-t'>
                                    ...
                                    <td className='py-4 px-6'>
                                        <img src={news} alt="news post" className='w-10 h-10 rounded-full object-cover' />
                                    </td>
